...
#include "core/src/aztec/AZHighLevelEncoder.h"
...
extern "C"
{
    ...
    {
        EncodeResult code = Aztec::Encoder::Encode_binary(data, Aztec::Encoder::DEFAULT_EC_PERCENT, Aztec::Encoder::DEFAULT_AZTEC_LAYERS);
